...
Open [http://localhost:8080](http://localhost:8080) in your browser. Bolly will guide you through the initial setup — including entering your API key — right in the web interface.
